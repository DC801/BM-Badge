...
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_COMMON_FLAGS}  -Wno-register")
set(CMAKE_ASM_FLAGS_INIT "${CMAKE_COMMON_FLAGS}")
set(CMAKE_EXE_LINKER_FLAGS_INIT "${LD_FLAGS} --specs=nosys.specs -Wl,--gc-sections,-print-memory-usage -L${SDK_ROOT}/modules/nrfx/mdk -T${CMAKE_CURRENT_LIST_DIR}/../Software/GameEngine/badge_gcc_nrf52.ld")
