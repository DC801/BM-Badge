...
const BADGE_INFO badgeInfo[NUM_BADGE_GROUPS - 1] = {
        ...
        { badge_FoB,            0x0069, "FoB",              nullptr,                       "@B1un7"            },
        { badge_diana,          0x1010, "Diana Init",       nullptr,                       "@B1un7"            },
        { badge_dc503,          0x0503, "DC503",            nullptr,                       "@r00tkillah"       },
        ...
        { badge_hak4kidz,       0x02E5, "Hak4Kidz",         nullptr,                       "@Hak4Kidz"         },
        { badge_ides,           0x1DE5, "IDES",             nullptr,                       "@Netik"            },
        { badge_dc858_619,      0x0698, "DC858/619",        nullptr,                       "@ellwoodthewood"   }
};
 ...
 * @return true if it wasn't nullptr
 */
...
static void ble_evt_handler(ble_evt_t const* p_ble_evt, void* p_context)
{
    ...
    static ADVERTISEMENT adv = { 0, 0, {0}, nullptr, 0, nullptr, 0 };
...
void ble_stack_init(void)
{
    ...
    NRF_SDH_BLE_OBSERVER(m_ble_observer, APP_BLE_OBSERVER_PRIO, ble_evt_handler, nullptr);


    app_timer_create(&ble_scan_timer, APP_TIMER_MODE_REPEATED, ble_scan_timeout_handler);
    app_timer_start(ble_scan_timer, DEFCON_BADGE_SCAN_INTERVAL, nullptr);
}
