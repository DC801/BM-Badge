...
The [web encoder](../encoder/web_encoder) has a few entity management tools. To use them, you must first upload your [scenario_source_files](../scenario_source_files)  folder to the web encoder.
