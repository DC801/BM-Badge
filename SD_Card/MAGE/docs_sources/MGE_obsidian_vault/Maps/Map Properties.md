...
Any entity's `on_tick` script is capable of watching for the player's movement into doorways, it is logical to assign this task to the map's `on_tick` script.
