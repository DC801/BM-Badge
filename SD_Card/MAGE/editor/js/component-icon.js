...
/></svg>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8"
	v-if="display === 'data-transfer-download'"
	:width="size"
	:height="size"
...
/></svg>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8"
	v-if="display === 'data-transfer-upload'"
	:width="size"
	:height="size"
...
/></svg>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8"
	v-if="display === 'double-quote-serif-left'"
	:width="size"
	:height="size"
...
><path d="M0 0v4h4v-4h-4zm5 2v3h-3v1h4v-4h-1zm2 2v3h-3v1h4v-4h-1z"
	:fill="colorHex"
/></svg>
<svg xmlns="http://www.w3.org/2000/svg" biewBox="0 0 8 8"
	v-if="display === 'lock-locked'"
	:width="size"
	:height="size"
